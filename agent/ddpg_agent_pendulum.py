...
class DQNAgent:
    def __init__(self):
        ...
        self.eval_actornet = ActorNet(3,1)
        self.target_actornet = ActorNet(3,1)
        self.target_actornet.load_state_dict(self.eval_actornet.state_dict())
        self.eval_criticnet =  CriticNet(3,1)
        self.target_criticnet = CriticNet(3,1)
        self.target_criticnet.load_state_dict(self.eval_criticnet.state_dict())
        self.actor_optimizer = torch.optim.Adam(self.eval_actornet.parameters(), lr=0.0001)
        self.critic_optimizer = torch.optim.Adam(self.eval_criticnet.parameters(), lr=0.001,weight_decay=0.01)
